/**
 * This part of code is an open-source project by dberm22 under the MIT Licence.
 * I made some changes to fit my code.
...
public class SoundEffect implements Runnable{
    ...
    public void playSound() throws FileNotFoundException, UnsupportedAudioFileException, IOException, LineUnavailableException
    {
        ...
        else //if (filename.toLowerCase().endsWith(".mp3") || filename.toLowerCase().endsWith(".ogg"))
        {
            ...
            final URL fileurl = this.getClass().getClassLoader().getResource(filename);
